...
class _MyDropdownState extends State<MyDropdown> {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Text(widget.label, style: TextStyle(color: Colors.white, fontFamily: 'Scheherazade', fontSize: 20)),
        FutureBuilder(
          ...
          builder: (context, snapshot) => Theme(
            ...
            child: DropdownButton<String>(
              ...
              style: TextStyle(color: Colors.white, fontFamily: 'Scheherazade', fontSize: 20),
